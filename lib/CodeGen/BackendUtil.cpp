...
//#define INSTRUMENT_ANALYZED_LOOPS
...
#ifdef ANALYZE_LOOPS
#   ifdef INSTRUMENT_ANALYZED_LOOPS
  loopanalysis::LoopAnalysis LA(TheModule, true);
#   else
  loopanalysis::LoopAnalysis LA(TheModule, false);
#   endif
  LA.Analyze();
#else
